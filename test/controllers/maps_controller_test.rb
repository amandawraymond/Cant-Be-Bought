...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { abbreviation: @map.abbreviation, code: @map.code, country: @map.country, tier: @map.tier, type: @map.type }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { abbreviation: @map.abbreviation, code: @map.code, country: @map.country, tier: @map.tier, type: @map.type }
    assert_redirected_to map_path(assigns(:map))
  end
